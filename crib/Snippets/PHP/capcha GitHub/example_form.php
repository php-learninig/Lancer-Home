...
$GLOBALS['ct_recipient']
    = 'YOU@EXAMPLE.COM'; // Change to your email address!  Make sure DEBUG_MODE above is 0 for mail to send!
...
<p class="note">
  ...
  This example form also demonstrates how to submit a form to itself to display error messages.
    ...
    if(isset($_SESSION['ctform']['error'])
        && $_SESSION['ctform']['error']
        == true
    ...
    <?php elseif(isset($_SESSION['ctform']['success'])
        && $_SESSION['ctform']['success']
        == true
    ): /* form was processed successfully */ ?>
        <div class="success">The captcha was correct and the message has been sent!  The captcha was solved in <?php echo $_SESSION['ctform']['timetosolve'] ?>
            seconds.</div><br />
    <?php endif; ?>
  ...
  <p>
    <label for="ct_name">Name*:</label>
      ...
      <input type="text" id="ct_name" name="ct_name" size="35" value="<?php echo htmlspecialchars(
          @$_SESSION['ctform']['ct_name']
      ) ?>">
  </p>
  ...
  <p>
    <label for="ct_email">Email*:</label>
      ...
      <input type="text" id="ct_email" name="ct_email" size="35" value="<?php echo htmlspecialchars(
          @$_SESSION['ctform']['ct_email']
      ) ?>">
  </p>
  ...
  <p>
    <label for="ct_URL">URL:</label>
      ...
      <input type="text" id="ct_URL" name="ct_URL" size="35" value="<?php echo htmlspecialchars(
          @$_SESSION['ctform']['ct_URL']
      ) ?>">
  </p>
  ...
  <p>
    <label for="ct_message">Message*:</label>
      ...
      <textarea id="ct_message" name="ct_message" rows="12" cols="60"><?php echo htmlspecialchars(
              @$_SESSION['ctform']['ct_message']
          ) ?></textarea>
  </p>
