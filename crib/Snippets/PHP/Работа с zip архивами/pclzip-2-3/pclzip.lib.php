...
//  function add($p_filelist, $p_add_dir="", $p_remove_dir="")
    ...
    function privAddFile($p_filename, &$p_header, $p_add_dir, $p_remove_dir, $p_remove_all_dir, &$p_options)
    {
        ...
        // ----- Look for partial path remove
            ...
            if($v_compare > 0) //      if (substr($p_filename, 0, strlen($p_remove_dir)) == $p_remove_dir)
            {
...
// --------------------------------------------------------------------------------
    ...
    function privDeleteByRule(&$p_result_list, &$p_options)
    {
        ...
        if($v_nb_extracted > 0) {
            ...
            // ----- Create the central dir footer
            if(($v_result = $v_temp_zip->privWriteCentralHeader(sizeof($v_header_list), $v_size, $v_offset, $v_comment))
                != 1
            ) {
                // ----- Reset the file list
                unset($v_header_list);
